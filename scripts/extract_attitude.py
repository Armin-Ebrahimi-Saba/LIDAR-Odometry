...
The bag does not embed the message definition, so data/px4_msgs/msg/VehicleAttitude
...
Usage:
    python scripts/extract_attitude.py [--config /configs/config_test1.yaml] [--margin 1.0] [--output PATH]
"""
import argparse
...
# data/px4_msgs/msg/VehicleAttitude -- field order/types must match the recorded
...
def _typestore_with_attitude():
    ...
    ts.register(get_types_from_msg(_VEHICLE_ATTITUDE_MSG, "data/px4_msgs/msg/VehicleAttitude"))
    return ts
