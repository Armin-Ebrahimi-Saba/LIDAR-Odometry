...
The bag stores px4_msgs/msg/SensorGps as raw CDR but does NOT embed the message
...
# px4_msgs/msg/SensorGps -- field order/types must match the recorded message
...
def _typestore_with_sensor_gps():
    ...
    ts.register(get_types_from_msg(_SENSOR_GPS_MSG, "px4_msgs/msg/SensorGps"))
    return ts
